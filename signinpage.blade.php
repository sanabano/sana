...
<ul class="tab">
  ...
  <li><a href="#" class="tablinks" items(event, 'SignIn')">SignIn</a></li>
</ul> </ul>
</div>
<div  class="col-md-12" style="border:3px; border-color:#474445; padding: 14px 16px; ">
...
<center>
        ...
        <br><input type="text" id="username" placeholder="user_name">
    </center></div>
<div>
<center>
...
<br> <div class="button">
        ...
        <br><div><center><ul>
<li><a href="username.html" onclick="items(events,'ForgotPassword')"> Forgot Password? </a>
</li></ul></center></div></td></table></div>
    </div></form></div></div></div></div></td></table></div></body></html>